...
@section('main')
<h1>Мой аккаунт:</h1>
<div class="user__email">Ваш email: {{ $user->email }} @if (!$user->email_verified_at) (не подтвержден) @elseif (date('Y-m-d', strtotime($user->updated_at . "+20 days")) < date('Y-m-d', time())) Пожалуйста, подтвердите повторно Ваш Email @endif</div>
